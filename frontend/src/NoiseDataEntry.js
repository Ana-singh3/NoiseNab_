...
const noiseSourceOptions = [
  ...
  { code: 'R', label: 'Residential' },
  { code: 'S', label: 'Silence' }
];
...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    ? { lat: parseFloat(manualLocation.split(",")[0]), lng: parseFloat(manualLocation.split(",")[1]) } 
    ...
    try {
        ...
        setNoiseSource(''); // Clear noise source after successful submission
      } catch (error) {
